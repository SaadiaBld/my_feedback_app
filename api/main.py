...
def create_api_app():
        ...
        # bloc 2: Écrit le fichier temporaire à partir du contenu JSON
    ...
    ###bloc pour execution locales à décommenter si on lance en local et commenter le bloc ci dessus
